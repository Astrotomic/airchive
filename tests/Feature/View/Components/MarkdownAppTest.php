...
class MarkdownAppTest extends AppTestCase
{
    ...
    public function test_it_renders_empty_markdown_without_markup(): void
    {
        Assert::assertSame('', trim($this->renderMarkdown(" \n ")));
    }

    public function test_url_chips_include_non_default_ports(): void
    {
        $html = $this->renderMarkdown('[https://example.com:8443/path](https://example.com:8443/path)');

        Assert::assertStringContainsString('>example.com:8443</span>', $html);
    }
