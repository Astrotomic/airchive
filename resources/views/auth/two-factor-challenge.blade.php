...
@section ('content')
    <div class="rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
        <h1 class="mb-2 text-2xl font-semibold">Two-factor authentication</h1>
        <p class="mb-6 text-sm text-gray-600">Enter the code from your authenticator app to continue.</p>
        ...
        <details class="mt-6">
            <summary class="cursor-pointer text-sm text-gray-600">Use a recovery code</summary>
            <form
                method="POST"
                action="{{ route('two-factor.login.store') }}"
